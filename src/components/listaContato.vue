  ...
  <div class="list row">
    ...
    <div class="col-md-6">
      ...
      <ul class="list-group">
        <li class="list-group-item"
          ...
          :key="index"
          @click="setActiveContatos(contato, index)"
        >
          {{ contato.nome }}
        </li>
      </ul>
    ...
    <div class="col-md-6">
      <div v-if="currentContato">
        <h4>Tutorial</h4>
        <div>
          <label><strong>Title:</strong></label> {{ currentContato.nome }}
        </div>
        <div>
          <label><strong>Description:</strong></label> {{ currentContato.email }}
        </div>
        <div>
        ...
        <a class="badge badge-warning"
          :href="'/tutorials/' + currentContato.id" >
          Edit
        </a>
      </div>
      <div v-else>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            searchTitle() {
                contatoDataService.findByTitle(this.title)
                    .then(response => {
